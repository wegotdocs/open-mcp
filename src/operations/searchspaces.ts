...
export const toolName = `searchspaces`
export const toolDescription = `Search for Spaces`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/spaces/search`
