...
export const toolName = `usersidunlike`
export const toolDescription = `Causes the User (in the path) to unlike the specified Tweet`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/users/{id}/likes/{tweet_id}`
