...
export const toolName = `searchstream`
export const toolDescription = `Filtered stream`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/tweets/search/stream`
