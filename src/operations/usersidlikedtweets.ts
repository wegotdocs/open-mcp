...
export const toolName = `usersidlikedtweets`
export const toolDescription = `Returns Tweet objects liked by the provided User ID`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/users/{id}/liked_tweets`
