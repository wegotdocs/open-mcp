...
export const toolName = `gettweetssample10stream`
export const toolDescription = `Sample 10% stream`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/tweets/sample10/stream`
