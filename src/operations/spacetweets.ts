...
export const toolName = `spacetweets`
export const toolDescription = `Retrieve Tweets from a Space.`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/spaces/{id}/tweets`
