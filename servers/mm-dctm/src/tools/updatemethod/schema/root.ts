...
export const inputParamsSchema = {
  ...
  "run-method": z.string().describe("It runs the method").optional(),
  "use-content": z.string().describe("Allows user to specify whether to use the content while running the method. If the parameter is set to true, it updates the use_method_content parameter of the method").optional(),
