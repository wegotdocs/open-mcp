...
export const inputParamsSchema = {
  ...
  "checked-out-by": z.enum(["CURRENT_USER","SPECIFIC_USER","ANY"]).describe("Specifies the lock owner of the checked out objects with the following valid values").optional(),
  "user-name": z.string().describe("Specifies the user name of the lock owner. Only works when the checked-out-by parameter is set to specific-user").optional(),
  "include-all-versions": z.string().describe("Whether include all versions").optional(),
