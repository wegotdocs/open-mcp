...
export const inputParamsSchema = {
  ...
  "parent-type": z.string().describe("Gets direct sub types or all sub types of the specified type.").optional(),
  "recursive": z.string().describe("Specifies whether get direct or indirect sub types").optional(),
  ...
  "dml-view": z.enum(["BASIC","NONE","ALL"]).describe("Specifies what shall be returned for the collection.").optional(),
