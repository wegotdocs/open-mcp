...
const tool: OpenMCPServerTool = {
  "toolName": "updatecurrentuserpreference",
  "toolDescription": "Update the currentUserPreference",
  "baseUrl": "http://localhost:8080/dctm-rest",
  "path": "/repositories/{repositoryName}/currentuser-preferences/{clientCode}",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
