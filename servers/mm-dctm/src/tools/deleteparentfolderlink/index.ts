...
const tool: OpenMCPServerTool = {
  "toolName": "deleteparentfolderlink",
  "toolDescription": "Delete the parentFolderLink",
  "baseUrl": "http://localhost:8080/dctm-rest",
  "path": "/repositories/{repositoryName}/objects/{objectId}/parent-links/{parentFolderId}",
  "method": "delete",
  "security": [
    {
      "key": "Authorization",
