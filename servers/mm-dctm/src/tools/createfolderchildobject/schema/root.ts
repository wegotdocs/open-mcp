...
export const inputParamsSchema = {
  ...
  "content-length": z.string().describe("The byte count of the content uploaded. A comma separated list can be used to define multiple values for this parameter."),
