...
export const inputParamsSchema = {
  ...
  "check-subscription": z.string().describe("Ensures whether to show subscriptions on the object instance. * 'true', return subscriptions on the object instance. * 'false', do not return subscriptions on the object instance.").optional(),
