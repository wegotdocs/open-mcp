...
export const inputParamsSchema = {
  ...
  "sort": z.array(z.enum(["id","-id","name","-name","extension","-extension","size","-size","width","-width","height","-height","createdTime","-createdTime","updatedTime","-updatedTime"])).describe("The collection items sort field and order (prefix with \"-\" for descending sort).").optional()
}