import { z } from "zod";
export const toolName = `enterprise_admin_add_org_access_to_self_hosted_runner_group_in_e`;
export const toolDescription = `Add organization access to a self-hosted runner group in an enterprise`;
