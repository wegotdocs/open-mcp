...
```json
{
  "mcpServers": {
    "agenta-ai": {
      ...
      "url": "https://mcp.open-mcp.org/api/server/agenta-ai@latest/mcp"
    }
  }
}
```
...
```ini
https://mcp.open-mcp.org/api/server/agenta-ai@latest/mcp?FORWARD_VAR_OPEN_MCP_BASE_URL=https%3A%2F%2Fapi.example.com
```
