...
export const toolName = `getdeviceclients`
export const toolDescription = `List the clients of a device, up to a maximum of a month ago`
export const baseUrl = `https://api.meraki.com/api/v1`
export const path = `/devices/{serial}/clients`
