import { z } from "zod";
export const toolName = `getdevicewirelesslatencystats`;
export const toolDescription = `Aggregated latency info for a given AP on this network`;
export const baseUrl = `https://api.meraki.com/api/v1`;
export const path = `/devices/{serial}/wireless/latencyStats`;
