import { z } from "zod";
export const toolName = `updatenetworkappliancefirewallinboundcellularfirewallrules`;
export const toolDescription = `Update the inbound cellular firewall rules of an MX network`;
export const baseUrl = `https://api.meraki.com/api/v1`;
export const path = `/networks/{networkId}/appliance/firewall/inboundCellularFirewallRules`;
