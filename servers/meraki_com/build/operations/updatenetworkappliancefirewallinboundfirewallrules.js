import { z } from "zod";
export const toolName = `updatenetworkappliancefirewallinboundfirewallrules`;
export const toolDescription = `Update the inbound firewall rules of an MX network`;
