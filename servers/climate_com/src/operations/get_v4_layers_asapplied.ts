...
export const toolName = `get_v4_layers_asapplied`
export const toolDescription = `Retrieve a list of application activities`
export const baseUrl = `https://platform.climate.com`
export const path = `/v4/layers/asApplied`
