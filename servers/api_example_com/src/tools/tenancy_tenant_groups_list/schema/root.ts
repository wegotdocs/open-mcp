...
export const inputParamsSchema = {
  ...
  "parent": z.array(z.string()).describe("Parent tenant group (slug)").optional(),
  "parent__n": z.array(z.string()).describe("Parent tenant group (slug)").optional(),
  "parent_id": z.array(z.number().int().nullable()).describe("Parent tenant group (ID)").optional(),
  "parent_id__n": z.array(z.number().int().nullable()).describe("Parent tenant group (ID)").optional(),
