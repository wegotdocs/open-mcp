...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this device role."),
  ...
  "vm_role": z.boolean().describe("Virtual machines may be assigned to this role").optional(),
