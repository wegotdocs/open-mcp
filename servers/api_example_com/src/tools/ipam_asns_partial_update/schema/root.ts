...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this ASN."),
  "asn": z.number().int().gte(1).lte(4294967295).describe("16- or 32-bit autonomous system number").optional(),
