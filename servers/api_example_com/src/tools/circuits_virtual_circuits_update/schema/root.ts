...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this virtual circuit."),
  "cid": z.string().min(1).max(100).describe("Unique circuit ID"),
  "provider_network": z.number().int(),
