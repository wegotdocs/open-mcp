...
export const inputParamsSchema = {
  ...
  "startValueDate": z.string().date().optional(),
  "endValueDate": z.string().date().optional(),
  "startOperationDate": z.string().date().optional(),
  "endOperationDate": z.string().date().optional(),
