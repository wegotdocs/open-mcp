...
export const inputParamsSchema = {
  ...
  "parent": z.array(z.string()).describe("Parent region (slug)").optional(),
  "parent__n": z.array(z.string()).describe("Parent region (slug)").optional(),
  "parent_id": z.array(z.number().int().nullable()).describe("Parent region (ID)").optional(),
  "parent_id__n": z.array(z.number().int().nullable()).describe("Parent region (ID)").optional(),
