...
export const inputParamsSchema = {
  ...
  "parent": z.array(z.string()).describe("Parent location (slug)").optional(),
  "parent__n": z.array(z.string()).describe("Parent location (slug)").optional(),
  "parent_id": z.array(z.number().int().nullable()).describe("Parent location (ID)").optional(),
  "parent_id__n": z.array(z.number().int().nullable()).describe("Parent location (ID)").optional(),
