...
export const inputParamsSchema = {
  "asn": z.array(z.number().int().gte(1).lte(4294967295)).describe("ASN").optional(),
  "asn__n": z.array(z.number().int().gte(1).lte(4294967295)).describe("ASN").optional(),
  "asn_id": z.array(z.number().int()).describe("ASN (ID)").optional(),
  "asn_id__n": z.array(z.number().int()).describe("ASN (ID)").optional(),
