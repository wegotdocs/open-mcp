...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this virtual device context."),
  "name": z.string().min(1).max(64).optional(),
  "device": z.number().int().optional(),
  "identifier": z.number().int().gte(0).lte(32767).nullable().optional(),
  ...
  "status": z.enum(["active","planned","offline"]).describe("* `active` - Active\n* `planned` - Planned\n* `offline` - Offline").optional(),
