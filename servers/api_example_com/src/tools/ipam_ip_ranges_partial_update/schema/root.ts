...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this IP range."),
  "start_address": z.string().min(1).optional(),
  "end_address": z.string().min(1).optional(),
  "vrf": z.number().int().nullable().optional(),
  "tenant": z.number().int().nullable().optional(),
  "status": z.enum(["active","reserved","deprecated"]).describe("Operational status of this range\n\n* `active` - Active\n* `reserved` - Reserved\n* `deprecated` - Deprecated").optional(),
  ...
  "mark_populated": z.boolean().describe("Prevent the creation of IP addresses within this range").optional(),
  "mark_utilized": z.boolean().describe("Report space as 100% utilized").optional()
}