...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this route target."),
  "name": z.string().min(1).max(21).describe("Route target value (formatted in accordance with RFC 4360)").optional(),
