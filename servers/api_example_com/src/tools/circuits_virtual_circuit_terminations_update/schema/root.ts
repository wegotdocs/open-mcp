...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this virtual circuit termination."),
  "virtual_circuit": z.number().int(),
  "role": z.enum(["peer","hub","spoke"]).describe("* `peer` - Peer\n* `hub` - Hub\n* `spoke` - Spoke").optional(),
