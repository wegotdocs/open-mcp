...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this device type."),
  ...
  "u_height": z.number().gte(0).lt(1000).optional(),
  "exclude_from_utilization": z.boolean().describe("Devices of this type are excluded when calculating rack utilization.").optional(),
  "is_full_depth": z.boolean().describe("Device consumes both front and rear rack faces.").optional(),
  "subdevice_role": z.union([z.literal("parent"), z.literal("child"), z.literal(""), z.literal(null)]).nullable().describe("Parent devices house child devices in device bays. Leave blank if this device type is neither a parent nor a child.\n\n* `parent` - Parent\n* `child` - Child").optional(),
  ...
  "front_image": z.string().base64().nullable().optional(),
  "rear_image": z.string().base64().nullable().optional(),
