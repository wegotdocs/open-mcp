...
export const inputParamsSchema = {
  ...
  "legalName": z.string().describe("contact legal name"),
  ...
  "customId": z.string().describe("Embat custom/auto unique contact ID. You can use as your custom ERP contact id").optional()
}