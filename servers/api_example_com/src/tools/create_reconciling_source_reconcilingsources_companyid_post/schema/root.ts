...
export const inputParamsSchema = {
  "companyId": z.string(),
  "name": z.string().describe("Name of the reconciling source"),
  ...
  "customId": z.string().describe("Embat custom/auto unique reconciling source ID. You can use as your internal reconciling source id")
}