...
export const inputParamsSchema = {
  ...
  "local_vid": z.array(z.number().int()).optional(),
  "local_vid__empty": z.boolean().optional(),
  "local_vid__gt": z.array(z.number().int()).optional(),
  "local_vid__gte": z.array(z.number().int()).optional(),
  "local_vid__lt": z.array(z.number().int()).optional(),
  "local_vid__lte": z.array(z.number().int()).optional(),
  "local_vid__n": z.array(z.number().int()).optional(),
  "modified_by_request": z.string().uuid().optional(),
  "offset": z.number().int().describe("The initial index from which to return the results.").optional(),
  "ordering": z.string().describe("Which field to use when ordering the results.").optional(),
  "policy": z.array(z.string()).describe("VLAN Translation Policy (name)").optional(),
  "policy__n": z.array(z.string()).describe("VLAN Translation Policy (name)").optional(),
  "policy_id": z.array(z.number().int()).describe("VLAN Translation Policy (ID)").optional(),
  "policy_id__n": z.array(z.number().int()).describe("VLAN Translation Policy (ID)").optional(),
  "q": z.string().describe("Search").optional(),
  "remote_vid": z.array(z.number().int()).optional(),
  "remote_vid__empty": z.boolean().optional(),
  "remote_vid__gt": z.array(z.number().int()).optional(),
  "remote_vid__gte": z.array(z.number().int()).optional(),
  "remote_vid__lt": z.array(z.number().int()).optional(),
  "remote_vid__lte": z.array(z.number().int()).optional(),
  "remote_vid__n": z.array(z.number().int()).optional(),
