...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this cluster."),
  "name": z.string().min(1).max(100).optional(),
  "type": z.number().int().optional(),
  "group": z.number().int().nullable().optional(),
  "status": z.enum(["planned","staging","active","decommissioning","offline"]).describe("* `planned` - Planned\n* `staging` - Staging\n* `active` - Active\n* `decommissioning` - Decommissioning\n* `offline` - Offline").optional(),
