...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this VRF."),
  "name": z.string().min(1).max(100),
  "rd": z.string().max(21).nullable().describe("Unique route distinguisher (as defined in RFC 4364)").optional(),
  "tenant": z.number().int().nullable().optional(),
  "enforce_unique": z.boolean().describe("Prevent duplicate prefixes/IP addresses within this VRF").optional(),
  "description": z.string().max(200).optional(),
  "comments": z.string().optional(),
  "import_targets": z.array(z.number().int()).optional(),
  "export_targets": z.array(z.number().int()).optional(),
