...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this service."),
  "parent_object_type": z.string().optional(),
  "parent_object_id": z.number().int().gte(0).lte(9223372036854776000).optional(),
  "name": z.string().min(1).max(100).optional(),
  "protocol": z.enum(["tcp","udp","sctp"]).describe("* `tcp` - TCP\n* `udp` - UDP\n* `sctp` - SCTP").optional(),
  "ports": z.array(z.number().int().gte(1).lte(65535)).optional(),
