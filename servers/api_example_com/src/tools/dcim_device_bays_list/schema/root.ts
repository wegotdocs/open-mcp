...
export const inputParamsSchema = {
  ...
  "installed_device": z.array(z.string().nullable()).describe("Installed device (name)").optional(),
  "installed_device__n": z.array(z.string().nullable()).describe("Installed device (name)").optional(),
  "installed_device_id": z.array(z.number().int().nullable()).describe("Installed device (ID)").optional(),
  "installed_device_id__n": z.array(z.number().int().nullable()).describe("Installed device (ID)").optional(),
