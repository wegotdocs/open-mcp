...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this journal entry."),
  "assigned_object_type": z.string(),
  "assigned_object_id": z.number().int().gte(0).lte(9223372036854776000),
  "created_by": z.number().int().nullable().optional(),
  "kind": z.enum(["info","success","warning","danger"]).describe("* `info` - Info\n* `success` - Success\n* `warning` - Warning\n* `danger` - Danger").optional(),
