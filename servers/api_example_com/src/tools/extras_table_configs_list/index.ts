...
const tool: OpenMCPServerTool = {
  "toolName": "extras_table_configs_list",
  "toolDescription": "Get a list of table config objects.",
  ...
  "paramsMap": {
    "query": {
      ...
      "table__ic": "table__ic",
      "table__ie": "table__ie",
      "table__iew": "table__iew",
      "table__isw": "table__isw",
      "table__n": "table__n",
      "table__nic": "table__nic",
      "table__nie": "table__nie",
      "table__niew": "table__niew",
      "table__nisw": "table__nisw",
