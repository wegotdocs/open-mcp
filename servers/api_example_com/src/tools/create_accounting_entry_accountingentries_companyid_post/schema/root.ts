...
export const inputParamsSchema = {
  ...
  "counterpartAccountingCode": z.string().describe("counterpart ledger account code").optional(),
  "accountingName": z.string().optional(),
  "assetAmount": z.number(),
  "accountingAssetAmount": z.number().optional(),
  "balance": z.number().describe("relative balance of ledger account post entry").optional(),
  "liabilityAmount": z.number(),
  "accountingLiabilityAmount": z.number().optional(),
  ...
  "contactCustomId": z.string().describe("contact custom id, when the accounting code is contacts account").optional(),
  ...
  "transactionsIds": z.array(z.string()).optional(),
  "paymentId": z.string().optional(),
  "date": z.string().datetime({ offset: true }),
  "attributes": z.array(z.object({ "customId": z.string(), "value": z.string(), "valueCustomId": z.string().optional() })).optional(),
  "customId": z.string().describe("Embat custom/auto unique accountingEntry ID. You can use as your custom ERP accounting entry id").optional(),
  "type": z.enum(["banks","analytics","accountings"]).describe("An enumeration.").optional(),
  "accountingEntryCode": z.string().optional(),
  "accountingEntryCodeId": z.string().optional()
}