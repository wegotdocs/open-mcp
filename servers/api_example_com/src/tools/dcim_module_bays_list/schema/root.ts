...
export const inputParamsSchema = {
  ...
  "installed_module_id": z.array(z.number().int()).describe("Installed module (ID)").optional(),
  "installed_module_id__n": z.array(z.number().int()).describe("Installed module (ID)").optional(),
  ...
  "parent_id": z.array(z.number().int().nullable()).describe("Parent module bay (ID)").optional(),
  "parent_id__n": z.array(z.number().int().nullable()).describe("Parent module bay (ID)").optional(),
  "position": z.array(z.string()).optional(),
  "position__empty": z.boolean().optional(),
  "position__ic": z.array(z.string()).optional(),
  "position__ie": z.array(z.string()).optional(),
  "position__iew": z.array(z.string()).optional(),
  "position__isw": z.array(z.string()).optional(),
  "position__n": z.array(z.string()).optional(),
  "position__nic": z.array(z.string()).optional(),
  "position__nie": z.array(z.string()).optional(),
  "position__niew": z.array(z.string()).optional(),
  "position__nisw": z.array(z.string()).optional(),
