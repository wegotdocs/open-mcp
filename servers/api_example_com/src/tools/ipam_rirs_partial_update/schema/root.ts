...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this RIR."),
  "name": z.string().min(1).max(100).optional(),
  "slug": z.string().regex(new RegExp("^[-a-zA-Z0-9_]+$")).min(1).max(100).optional(),
  "is_private": z.boolean().describe("IP space managed by this RIR is considered private").optional(),
