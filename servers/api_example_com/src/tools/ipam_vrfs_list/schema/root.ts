...
export const inputParamsSchema = {
  ...
  "export_target": z.array(z.string()).describe("Export target (name)").optional(),
  "export_target__n": z.array(z.string()).describe("Export target (name)").optional(),
  "export_target_id": z.array(z.number().int()).describe("Export target").optional(),
  "export_target_id__n": z.array(z.number().int()).describe("Export target").optional(),
  ...
  "import_target": z.array(z.string()).describe("Import target (name)").optional(),
  "import_target__n": z.array(z.string()).describe("Import target (name)").optional(),
  "import_target_id": z.array(z.number().int()).describe("Import target").optional(),
  "import_target_id__n": z.array(z.number().int()).describe("Import target").optional(),
  ...
  "rd": z.array(z.string()).optional(),
  "rd__empty": z.boolean().optional(),
  "rd__ic": z.array(z.string()).optional(),
  "rd__ie": z.array(z.string()).optional(),
  "rd__iew": z.array(z.string()).optional(),
  "rd__isw": z.array(z.string()).optional(),
  "rd__n": z.array(z.string()).optional(),
  "rd__nic": z.array(z.string()).optional(),
  "rd__nie": z.array(z.string()).optional(),
  "rd__niew": z.array(z.string()).optional(),
  "rd__nisw": z.array(z.string()).optional(),
