...
export const inputParamsSchema = {
  ...
  "image_height": z.array(z.number().int()).optional(),
  "image_height__empty": z.boolean().optional(),
  "image_height__gt": z.array(z.number().int()).optional(),
  "image_height__gte": z.array(z.number().int()).optional(),
  "image_height__lt": z.array(z.number().int()).optional(),
  "image_height__lte": z.array(z.number().int()).optional(),
  "image_height__n": z.array(z.number().int()).optional(),
  "image_width": z.array(z.number().int()).optional(),
  "image_width__empty": z.boolean().optional(),
  "image_width__gt": z.array(z.number().int()).optional(),
  "image_width__gte": z.array(z.number().int()).optional(),
  "image_width__lt": z.array(z.number().int()).optional(),
  "image_width__lte": z.array(z.number().int()).optional(),
  "image_width__n": z.array(z.number().int()).optional(),
