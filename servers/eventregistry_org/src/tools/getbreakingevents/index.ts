...
const tool: OpenMCPServerTool = {
  "toolName": "getbreakingevents",
  "toolDescription": "Retrieve the list of breaking events",
  "baseUrl": "https://eventregistry.org",
  "path": "/api/v1/event/getBreakingEvents",
  "method": "get",
  "security": [],
  "paramsMap": {
    "query": {
      "apiKey": "apiKey",
      "breakingEventsCount": "breakingEventsCount",
      "breakingEventsPage": "breakingEventsPage",
      "breakingEventsMinBreakingScore": "breakingEventsMinBreakingScore",
