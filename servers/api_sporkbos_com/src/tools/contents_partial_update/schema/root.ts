...
export const inputParamsSchema = {
  ...
  "parent_data": z.string().optional(),
  "category_name": z.string().readonly().optional(),
  "latest_result": z.string().readonly().optional(),
  "metric_collaborators_details": z.array(z.object({ "id": z.number().int(), "name": z.string(), "type": z.string() })).optional(),
  "is_page_edited": z.boolean().optional(),
  "required_relearning": z.boolean().optional(),
  "reschedule_confirmation": z.boolean().optional(),
