...
export const toolName = `apigee_organizations_environments_keyvaluemaps_create`
export const toolDescription = `Creates a key value map in an environment.`
export const baseUrl = `https://apigee.googleapis.com`
export const path = `/v1/organizations/{organizationsId}/environments/{environmentsId}/keyvaluemaps`
