...
export const toolName = `apigee_organizations_environments_modifyenvironment`
export const toolDescription = `Updates properties for an Apigee environment with patch semantics using a field mask. **Note:** Not supported for Apigee hybrid.`
