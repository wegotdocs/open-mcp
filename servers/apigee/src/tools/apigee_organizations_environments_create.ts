...
export const toolName = `apigee_organizations_environments_create`
export const toolDescription = `Creates an environment in an organization.`
export const baseUrl = `https://apigee.googleapis.com`
export const path = `/v1/organizations/{organizationsId}/environments`
