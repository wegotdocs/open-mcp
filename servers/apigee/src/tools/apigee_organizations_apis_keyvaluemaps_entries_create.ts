...
export const toolName = `apigee_organizations_apis_keyvaluemaps_entries_create`
...
export const path = `/v1/organizations/{organizationsId}/apis/{apisId}/keyvaluemaps/{keyvaluemapsId}/entries`
