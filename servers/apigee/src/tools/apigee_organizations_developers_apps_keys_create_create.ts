...
export const toolName = `apigee_organizations_developers_apps_keys_create_create`
...
export const path = `/v1/organizations/{organizationsId}/developers/{developersId}/apps/{appsId}/keys/create`
