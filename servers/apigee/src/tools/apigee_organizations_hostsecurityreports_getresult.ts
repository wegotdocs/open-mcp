...
export const toolName = `apigee_organizations_hostsecurityreports_getresult`
...
export const path = `/v1/organizations/{organizationsId}/hostSecurityReports/{hostSecurityReportsId}/result`
