...
export const toolName = `apigee_organizations_securityprofiles_patch`
export const toolDescription = `UpdateSecurityProfile update the metadata of security profile.`
