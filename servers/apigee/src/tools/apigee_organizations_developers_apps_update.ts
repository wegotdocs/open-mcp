...
export const toolName = `apigee_organizations_developers_apps_update`
export const toolDescription = `Updates the details for a developer app. In addition, you can add an API product to a developer app and automatically generate an API key for the app to use when calling APIs in the API product. If you want to use an existing API key for th`
