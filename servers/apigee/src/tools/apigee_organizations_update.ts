...
export const toolName = `apigee_organizations_update`
export const toolDescription = `Updates the properties for an Apigee organization. No other fields in the organization profile will be updated.`
