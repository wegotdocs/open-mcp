...
export const toolName = `apigee_organizations_analytics_datastores_create`
export const toolDescription = `Create a Datastore for an org`
export const baseUrl = `https://apigee.googleapis.com`
export const path = `/v1/organizations/{organizationsId}/analytics/datastores`
