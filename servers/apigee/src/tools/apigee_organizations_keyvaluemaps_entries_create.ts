...
export const toolName = `apigee_organizations_keyvaluemaps_entries_create`
...
export const path = `/v1/organizations/{organizationsId}/keyvaluemaps/{keyvaluemapsId}/entries`
