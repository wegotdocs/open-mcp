...
export const inputParamsSchema = {
  "domain": z.string().nullable().describe("Host header to send in the HTTP request. May not contain spaces, percent or backslash symbols. Can be null, in that case no host header is sent.").optional(),
  "path": z.string().describe("HTTP path to use for health checks. May not contain literal spaces, use percent-encoding instead.").optional(),
