...
export const inputParamsSchema = {
  ...
  "fingerprint": z.string().describe("Can be used to filter SSH keys by their fingerprint. The response will only contain the SSH key matching the specified fingerprint.").optional(),
