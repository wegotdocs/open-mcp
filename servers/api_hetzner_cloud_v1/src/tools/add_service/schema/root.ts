...
export const inputParamsSchema = {
  ...
  "destination_port": z.number().int().describe("Port the Load Balancer will balance to"),
  ...
  "protocol": z.enum(["http","https","tcp"]).describe("Protocol of the Load Balancer"),
  "proxyprotocol": z.boolean().describe("Is Proxyprotocol enabled or not")
}