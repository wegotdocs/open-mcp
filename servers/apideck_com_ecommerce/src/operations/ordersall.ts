...
export const toolName = `ordersall`
export const toolDescription = `List Orders`
export const baseUrl = `https://unify.apideck.com`
export const path = `/ecommerce/orders`
