...
export const inputParamsSchema = {
  ...
  "name": z.string().describe("Payment link name").optional(),
  ...
  "active": z.boolean().describe("Determines whether the payments link is active").optional(),
  "billingType": z.enum(["UNDEFINED","BOLETO","CREDIT_CARD","PIX"]).describe("Allowed payment method").optional(),
  "chargeType": z.enum(["DETACHED","RECURRENT","INSTALLMENT"]).describe("Charge type").optional(),
