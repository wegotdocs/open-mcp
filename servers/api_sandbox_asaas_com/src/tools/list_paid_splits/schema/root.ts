...
export const inputParamsSchema = {
  ...
  "creditDate[ge]": z.string().describe("Filter from the initial split sending date").optional(),
  "creditDate[le]": z.string().describe("Filter from the final split sending date").optional()
}