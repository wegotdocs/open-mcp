import { z } from "zod";
export const toolName = `list_transfers`;
export const toolDescription = `List transfers`;
export const baseUrl = `https://api.codat.io`;
export const path = `/companies/{companyId}/connections/{connectionId}/data/transfers`;
