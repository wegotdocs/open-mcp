import { z } from "zod";
export const toolName = `get_direct_costs`;
export const toolDescription = `List direct costs`;
export const baseUrl = `https://api.codat.io`;
export const path = `/companies/{companyId}/connections/{connectionId}/data/directCosts`;
