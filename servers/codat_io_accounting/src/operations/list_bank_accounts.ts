...
export const toolName = `list_bank_accounts`
export const toolDescription = `List bank accounts`
export const baseUrl = `https://api.codat.io`
export const path = `/companies/{companyId}/connections/{connectionId}/data/bankAccounts`
