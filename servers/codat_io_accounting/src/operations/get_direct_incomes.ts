...
export const toolName = `get_direct_incomes`
export const toolDescription = `Get direct incomes`
export const baseUrl = `https://api.codat.io`
export const path = `/companies/{companyId}/connections/{connectionId}/data/directIncomes`
