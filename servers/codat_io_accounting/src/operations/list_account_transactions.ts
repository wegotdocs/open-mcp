...
export const toolName = `list_account_transactions`
export const toolDescription = `List account transactions`
export const baseUrl = `https://api.codat.io`
export const path = `/companies/{companyId}/connections/{connectionId}/data/accountTransactions`
