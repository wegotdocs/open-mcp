...
export const toolName = `getstorageservicebyfqn`
export const toolDescription = `Get storage service by name`
export const baseUrl = `/api`
export const path = `/v1/services/storageServices/name/{name}`
