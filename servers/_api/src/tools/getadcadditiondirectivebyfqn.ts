...
export const toolName = `getadcadditiondirectivebyfqn`
export const toolDescription = `Get a entity addition directive by name`
export const baseUrl = `/api`
export const path = `/v1/metadata/adcAdditionDirectives/name/{name}`
