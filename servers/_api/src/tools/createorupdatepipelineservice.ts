...
export const toolName = `createorupdatepipelineservice`
export const toolDescription = `Update pipeline service`
export const baseUrl = `/api`
export const path = `/v1/services/pipelineServices`
