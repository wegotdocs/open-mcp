import { z } from "zod";
export const toolName = `taxratesall`;
export const toolDescription = `List Tax Rates`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/accounting/tax-rates`;
