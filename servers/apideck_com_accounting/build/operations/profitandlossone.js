import { z } from "zod";
export const toolName = `profitandlossone`;
export const toolDescription = `Get Profit and Loss`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/accounting/profit-and-loss`;
