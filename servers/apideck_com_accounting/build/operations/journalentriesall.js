import { z } from "zod";
export const toolName = `journalentriesall`;
export const toolDescription = `List Journal Entries`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/accounting/journal-entries`;
