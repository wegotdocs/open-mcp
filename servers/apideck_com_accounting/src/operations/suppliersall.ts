...
export const toolName = `suppliersall`
export const toolDescription = `List Suppliers`
export const baseUrl = `https://unify.apideck.com`
export const path = `/accounting/suppliers`
