...
export const toolName = `billsall`
export const toolDescription = `List Bills`
export const baseUrl = `https://unify.apideck.com`
export const path = `/accounting/bills`
