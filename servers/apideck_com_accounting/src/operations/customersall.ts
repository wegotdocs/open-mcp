...
export const toolName = `customersall`
export const toolDescription = `List Customers`
export const baseUrl = `https://unify.apideck.com`
export const path = `/accounting/customers`
