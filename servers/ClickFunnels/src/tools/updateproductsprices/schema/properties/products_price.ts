...
export const inputParamsSchema = {
  ...
  "duration": z.number().int().nullable().describe("Duration").optional(),
  "interval": z.string().nullable().describe("Interval").optional(),
  "trial_interval": z.string().nullable().describe("Trial interval").optional(),
  "trial_duration": z.number().int().nullable().describe("Trial duration").optional(),
  "trial_amount": z.string().nullable().describe("Trial amount").optional(),
  ...
  "interval_count": z.number().int().nullable().describe("Interval count").optional(),
