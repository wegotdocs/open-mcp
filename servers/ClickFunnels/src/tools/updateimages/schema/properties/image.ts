...
export const inputParamsSchema = {
  ...
  "upload_source_url": z.string().describe("The source URL of the image that you want to upload. Not required on Update when not needed to re-upload the image.").optional()
}