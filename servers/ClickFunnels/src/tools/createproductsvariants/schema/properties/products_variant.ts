...
export const inputParamsSchema = {
  ...
  "product_type": z.string().describe("Type"),
  ...
  "weight_unit": z.string().describe("Weight unit"),
  ...
  "properties_values": z.array(z.object({ "property_id": z.number().int().describe("The ID of the property").optional(), "value": z.string().describe("The value").optional() })).describe("The property values of the Variant. e.g. 'Large', 'Red' etc.")
}