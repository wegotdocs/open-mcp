...
const tool: OpenMCPServerTool = {
  "toolName": "putrecurrentinvoicedata",
  "toolDescription": "Create or update recurrent invoice",
  "baseUrl": "https://agepyme.finutive.com/api/",
  "path": "/businesses/{businessId}/invoices/recurrence",
  "method": "put",
  "security": [
    {
      "key": "wzu",
  ...
  "paramsMap": {
    ...
    "body": {
      ...
      "pay_day": "pay_day",
      "set_next_at_first_day": "set_next_at_first_day",
      "without_last_pay_date": "without_last_pay_date",
