...
export const inputParamsSchema = {
  ...
  "first_invoice": z.string().optional(),
  "pay_day": z.string().datetime({ offset: true }).optional(),
  "set_next_at_first_day": z.boolean().optional(),
  "without_last_pay_date": z.boolean().optional(),
  "last_pay_date": z.string().datetime({ offset: true }).optional()
}