import { z } from "zod";
export const toolName = `collectionlistingsall`;
export const toolDescription = `List collection listings`;
export const baseUrl = `https://api.apideck.com`;
export const path = `/ecosystems/{ecosystem_id}/collections/{id}/listings`;
