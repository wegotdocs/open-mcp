...
export const toolName = `categorylistingsall`
export const toolDescription = `List category listings`
export const baseUrl = `https://api.apideck.com`
export const path = `/ecosystems/{ecosystem_id}/categories/{id}/listings`
