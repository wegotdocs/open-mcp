...
export const inputParamsSchema = {
  ...
  "orderby": z.enum(["id","include","name","registered_date"]).describe("Sort collection by object attribute.").optional(),
  "email": z.string().email().describe("Limit result set to resources with a specific email.").optional(),
  "role": z.enum(["all","administrator","editor","author","contributor","subscriber","customer","shop_manager"]).describe("Limit result set to resources with a specific role.").optional()
}