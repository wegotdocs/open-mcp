...
export const inputParamsSchema = {
  ...
  "status": z.array(z.enum(["any","trash","pending","processing","on-hold","completed","cancelled","refunded","failed"])).describe("Limit result set to orders which have specific statuses.").optional(),
  "customer": z.number().int().describe("Limit result set to orders assigned a specific customer.").optional(),
  "product": z.number().int().describe("Limit result set to orders assigned a specific product.").optional(),
