import { z } from "zod";
export const toolName = `get_associations_v3_rules_ruleid_`;
export const toolDescription = `Gets all devices associated with a rule`;
export const baseUrl = `https://tracking.api.here.com`;
export const path = `/associations/v3/rules/{ruleId}`;
