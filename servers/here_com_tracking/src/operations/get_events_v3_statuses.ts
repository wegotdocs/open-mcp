...
export const toolName = `get_events_v3_statuses`
export const toolDescription = `Gets the event statuses`
...
export const inputParams = z.object({ "query": z.object({ "eventSource": z.any().superRefine((x, ctx) => {
