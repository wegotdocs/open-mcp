...
export const toolName = `drivegroupsall`
export const toolDescription = `List DriveGroups`
export const baseUrl = `https://unify.apideck.com`
export const path = `/file-storage/drive-groups`
