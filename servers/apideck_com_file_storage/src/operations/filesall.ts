...
export const toolName = `filesall`
export const toolDescription = `List Files`
export const baseUrl = `https://unify.apideck.com`
export const path = `/file-storage/files`
