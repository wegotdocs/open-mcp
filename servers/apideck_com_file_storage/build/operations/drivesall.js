import { z } from "zod";
export const toolName = `drivesall`;
export const toolDescription = `List Drives`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/file-storage/drives`;
