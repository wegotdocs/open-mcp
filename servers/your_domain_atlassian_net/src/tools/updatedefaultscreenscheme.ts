...
export const inputParams = z.object({ "p_issueTypeScreenSchemeId": z.string().describe("The ID of the issue type screen scheme."), "b_screenSchemeId": z.string().describe("The ID of the screen scheme.") }).shape