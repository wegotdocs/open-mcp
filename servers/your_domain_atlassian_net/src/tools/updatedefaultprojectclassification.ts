...
export const inputParams = z.object({ "p_projectIdOrKey": z.string().describe("The project ID or project key (case-sensitive)."), "b_id": z.string().describe("The ID of the project classification.") }).shape