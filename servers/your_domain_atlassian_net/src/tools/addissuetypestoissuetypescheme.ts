...
export const inputParams = z.object({ "p_issueTypeSchemeId": z.number().int().describe("The ID of the issue type scheme."), "b_issueTypeIds": z.array(z.string()).describe("The list of issue type IDs.") }).shape