...
export const inputParams = z.object({ "b_issueTypeSchemeId": z.string().describe("The ID of the issue type scheme."), "b_projectId": z.string().describe("The ID of the project.") }).shape