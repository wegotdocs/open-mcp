...
export const inputParams = z.object({ "p_id": z.number().int().describe("The ID of the workflow scheme that the draft belongs to."), "q_workflowName": z.string().describe("The name of the workflow.") }).shape