...
export const toolName = `get_nh_fossils_all`
export const toolDescription = `All New Horizons fossil groups or individual fossil`
export const baseUrl = `https://api.nookipedia.com`
export const path = `/nh/fossils/all`
