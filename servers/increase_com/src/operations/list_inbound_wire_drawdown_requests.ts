...
export const toolName = `list_inbound_wire_drawdown_requests`
export const toolDescription = `List Inbound Wire Drawdown Requests`
export const baseUrl = `https://api.increase.com`
export const path = `/inbound_wire_drawdown_requests`
