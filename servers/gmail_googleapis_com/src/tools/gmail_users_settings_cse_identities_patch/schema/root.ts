...
export const inputParamsSchema = {
  ...
  "b_emailAddress": z.string().describe("The email address for the sending identity. The email address must be the primary email address of the authenticated user.").optional(),
