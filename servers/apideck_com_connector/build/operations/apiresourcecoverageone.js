import { z } from "zod";
export const toolName = `apiresourcecoverageone`;
export const toolDescription = `Get API Resource Coverage`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/connector/apis/{id}/resources/{resource_id}/coverage`;
