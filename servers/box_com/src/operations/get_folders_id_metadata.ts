...
export const toolName = `get_folders_id_metadata`
export const toolDescription = `List metadata instances on folder`
export const baseUrl = `https://api.box.com/2.0`
export const path = `/folders/{folder_id}/metadata`
