...
export const toolName = `put_folders_id_add_shared_link`
export const toolDescription = `Add shared link to folder`
export const baseUrl = `https://api.box.com/2.0`
export const path = `/folders/{folder_id}#add_shared_link`
