...
export const toolName = `put_files_id_add_shared_link`
export const toolDescription = `Add shared link to file`
export const baseUrl = `https://api.box.com/2.0`
export const path = `/files/{file_id}#add_shared_link`
