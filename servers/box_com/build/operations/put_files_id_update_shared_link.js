import { z } from "zod";
export const toolName = `put_files_id_update_shared_link`;
export const toolDescription = `Update shared link on file`;
export const baseUrl = `https://api.box.com/2.0`;
export const path = `/files/{file_id}#update_shared_link`;
