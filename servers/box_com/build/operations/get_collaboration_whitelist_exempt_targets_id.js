import { z } from "zod";
export const toolName = `get_collaboration_whitelist_exempt_targets_id`;
export const toolDescription = `Get user exempt from collaboration domain restrictions`;
