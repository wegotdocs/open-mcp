...
export const toolName = `findtweetsthatquoteatweet`
export const toolDescription = `Retrieve Tweets that quote a Tweet.`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/tweets/{id}/quote_tweets`
