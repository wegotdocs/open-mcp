import { z } from "zod";
export const toolName = `monitoring_get_lb_droplets_health_checks`;
export const toolDescription = `Get Load Balancer Droplets Health Check Status Metrics`;
export const baseUrl = `https://api.digitalocean.com`;
export const path = `/v2/monitoring/metrics/load_balancer/droplets_health_checks`;
