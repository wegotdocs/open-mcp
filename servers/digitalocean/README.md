...
```ts
{
  ...
  "status": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:\nAn object containing a \`state\` attribute whose value is set to a string indicating the current status of the cluster.").optional(),
...
```ts
{
  "alerts": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:"),
...
```ts
{
  ...
  "bgp": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:\nOptional BGP configurations").optional()
}
```
...
```ts
{
  ...
  "input_schema": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:\nDescribe the input schema for the function so the agent may call it").optional(),
  "output_schema": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:\nDescribe the output schema for the function so the agent handle its response").optional()
}
```
...
```ts
{
  ...
  "spaces_data_source": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:\nSpaces Bucket Data Source").optional(),
  "web_crawler_data_source": z.record(z.any()).describe("[EXPANDABLE PARAMETER]:\nWebCrawlerDataSource").optional()
}
```
