...
export const toolName = `tendersadd`
export const toolDescription = `Create Tender`
export const baseUrl = `https://unify.apideck.com`
export const path = `/pos/tenders`
