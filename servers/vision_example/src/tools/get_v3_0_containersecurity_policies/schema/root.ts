...
export const inputParamsSchema = {
  ...
  "TMV1-Filter": z.string().max(1024).describe("The filter for retrieving a subset of the policies list. Include this parameter in every request that generates paginated output.\n\nSupported fields:\n* `name` -  The name of the policy\n* `xdrEnabled` - Whether XDR telemetry is enabled\n* `type` - The type of the policy. Supported values:  `userManaged`, `clusterManaged`\n\nSupported operators:\n* `eq` - Operator \"equal to\"\n* `and` - Operator \"and\"\n* `or` - Operator \"or\"\n* `not` - Operator \"not\"\n* `contains` - Operator that allows you to search for a specified string in a field\n* `()` - Symbols for grouping operands\n").optional()
}