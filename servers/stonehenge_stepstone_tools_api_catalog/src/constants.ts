...
export const OPERATION_FILES_RELATIVE = [
  ...
  "./tools/getentities/index.js",
  "./tools/getentitybyuid/index.js",
  "./tools/deleteentitybyuid/index.js",
  "./tools/getentitybyname/index.js",
  "./tools/getentityancestrybyname/index.js",
  "./tools/getentitiesbyrefs/index.js",
  "./tools/getentitiesbyquery/index.js",
  "./tools/getentityfacets/index.js",
  "./tools/createlocation/index.js",
  "./tools/getlocations/index.js",
  "./tools/getlocation/index.js",
