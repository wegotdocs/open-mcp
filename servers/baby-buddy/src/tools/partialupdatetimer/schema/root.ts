...
export const inputParamsSchema = {
  ...
  "b_child": z.number().int().nullable().optional(),
  "b_name": z.string().max(255).nullable().optional(),
  "b_start": z.string().datetime({ offset: true }).optional(),
  "duration": z.string().readonly().optional(),
  "b_user": z.number().int().nullable().optional()
}