...
export const inputParams = z.object({ "issueTypeSchemeId": z.string().describe("The ID of the issue type scheme."), "projectId": z.string().describe("The ID of the project.") }).shape