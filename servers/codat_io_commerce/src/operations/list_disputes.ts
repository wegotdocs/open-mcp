...
export const toolName = `list_disputes`
export const toolDescription = `List disputes`
export const baseUrl = `https://api.codat.io`
export const path = `/companies/{companyId}/connections/{connectionId}/data/commerce-disputes`
