import { z } from "zod";
export const toolName = `list_payment_methods`;
export const toolDescription = `List payment methods`;
export const baseUrl = `https://api.codat.io`;
export const path = `/companies/{companyId}/connections/{connectionId}/data/commerce-paymentMethods`;
