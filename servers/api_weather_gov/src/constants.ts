...
export const SERVER_NAME = "api_weather_gov"
...
export const OPERATION_FILES_RELATIVE = [
  ...
  "./tools/parameters_points_latitude_longitude_/index.js",
  "./tools/point_stations/index.js",
  "./tools/parameters_points_latitude_longitude_stations/index.js",
  ...
  "./tools/latest_product_type_location/index.js",
  "./tools/parameters_products_types_typeid_locations_locationid_latest/index.js",
