...
export const inputParamsSchema = {
  ...
  "create_response": z.boolean().describe("Whether or not to automatically generate a response when a VAD stop event occurs. Not available for transcription sessions.\n").optional(),
