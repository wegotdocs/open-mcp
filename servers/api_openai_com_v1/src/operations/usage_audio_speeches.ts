...
export const toolName = `usage_audio_speeches`
export const toolDescription = `Get audio speeches usage details for the organization.`
export const baseUrl = `https://api.openai.com/v1`
export const path = `/organization/usage/audio_speeches`
