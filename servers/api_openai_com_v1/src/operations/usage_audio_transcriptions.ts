...
export const toolName = `usage_audio_transcriptions`
export const toolDescription = `Get audio transcriptions usage details for the organization.`
export const baseUrl = `https://api.openai.com/v1`
export const path = `/organization/usage/audio_transcriptions`
