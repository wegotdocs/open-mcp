...
```bash
npx @open-mcp/_api_v3 add-to-client ~/Library/Application\ Support/Claude/claude_desktop_config.json
```
...
```bash
npx @open-mcp/_api_v3 add-to-client .cursor/mcp.json
```

### Other

```bash
npx @open-mcp/_api_v3 add-to-client /path/to/client/config.json
```
...
```bash
npx -y @modelcontextprotocol/inspector npx -y @open-mcp/_api_v3
```

- Open http://localhost:5173
- Transport type: `STDIO`
- Command: `npx`
- Arguments: `-y @open-mcp/_api_v3`
