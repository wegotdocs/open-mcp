import { z } from "zod";
export const toolName = `ipgeolocationwithconfidenceareaandhazardreportapi`;
export const toolDescription = `IP Geolocation with Confidence Area and Hazard Report API`;
export const baseUrl = `https://api.bigdatacloud.net`;
export const path = `/data/ip-geolocation-full`;
