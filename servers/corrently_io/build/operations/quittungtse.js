import { z } from "zod";
export const toolName = `quittungtse`;
export const toolDescription = `Retrieve TSE (Technische Sicherheitseinrichtung) Data for a given receipt (Strom-Quittung).`;
export const baseUrl = `https://api.corrently.io/v2.0`;
export const path = `/quittung/tse`;
