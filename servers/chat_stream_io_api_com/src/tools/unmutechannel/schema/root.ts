...
export const inputParamsSchema = {
  "channel_cids": z.array(z.string()).describe("Channel CIDs to mute (if multiple channels)").optional(),
  "expiration": z.number().int().describe("Duration of mute in milliseconds").optional(),
