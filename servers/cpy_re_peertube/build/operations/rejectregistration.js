import { z } from "zod";
export const toolName = `rejectregistration`;
export const toolDescription = `Reject registration`;
export const baseUrl = `https://peertube2.cpy.re`;
export const path = `/api/v1/users/registrations/{registrationId}/reject`;
