...
export const toolName = `getaccountvideos`
export const toolDescription = `List videos of an account`
export const baseUrl = `https://peertube2.cpy.re`
export const path = `/api/v1/accounts/{name}/videos`
export const method = `get`
export const security = []

export const inputParams = z.object({ "path": z.object({ "name": z.string().describe("The username or handle of the account") }).optional(), "query": z.object({ "categoryOneOf": z.any().superRefine((x, ctx) => {
