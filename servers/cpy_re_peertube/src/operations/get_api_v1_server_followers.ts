...
export const toolName = `get_api_v1_server_followers`
export const toolDescription = `List instances following the server`
export const baseUrl = `https://peertube2.cpy.re`
export const path = `/api/v1/server/followers`
