...
```bash
npx @open-mcp/config add acuvity-ai \
...
```json
{
  "mcpServers": {
    "acuvity-ai": {
      "command": "npx",
      "args": ["-y", "@open-mcp/acuvity-ai"],
      "env": {"API_KEY":"...","X_NAMESPACE":"..."}
    }
  }
}
```
...
```bash
npx -y @modelcontextprotocol/inspector npx -y @open-mcp/acuvity-ai
```

- Open http://localhost:5173
- Transport type: `STDIO`
- Command: `npx`
- Arguments: `-y @open-mcp/acuvity-ai`
...
```ts
{
  ...
  "result": z.array(z.record(z.any())).describe("The result of the request.").optional(),
  "spansPerSpanSet": z.number().int().describe("The max number of spans to return per span set. If set to -1, it means no span\nat all. 0 will use the default value (3).").optional(),
  "start": z.string().describe("The start of the time window in any format supported by\nhttps://github.com/araddon/dateparse.").optional(),
  "startRelative": z.string().describe("The relative start of the time window as time.Duration.").optional()
}
```
...
```ts
{
  ...
  "scope": z.enum(["All","Resource","Span","Intrinsic"]).describe("Specifies the scope of the tags.").optional(),
  "start": z.string().describe("The start of the time window in any format supported by\nhttps://github.com/araddon/dateparse.").optional(),
  "startRelative": z.string().describe("The relative start of the time window as time.Duration.").optional()
}
```

### create_tracetagvalues
