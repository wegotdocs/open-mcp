...
export const toolName = `get_products_status_status_count_json`
export const toolDescription = `Count Products filtered by status.`
export const baseUrl = `https://api.jumpseller.com/v1`
export const path = `/products/status/{status}/count.json`
