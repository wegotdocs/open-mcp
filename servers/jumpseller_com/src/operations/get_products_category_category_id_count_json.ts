...
export const toolName = `get_products_category_category_id_count_json`
export const toolDescription = `Count Products filtered by category.`
export const baseUrl = `https://api.jumpseller.com/v1`
export const path = `/products/category/{category_id}/count.json`
