...
export const toolName = `leadsall`
export const toolDescription = `List leads`
export const baseUrl = `https://unify.apideck.com`
export const path = `/lead/leads`
