import { z } from "zod";
export const toolName = `list_transaction_categories`;
export const toolDescription = `List all transaction categories`;
export const baseUrl = `https://api.codat.io`;
export const path = `/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories`;
