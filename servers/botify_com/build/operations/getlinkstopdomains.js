import { z } from "zod";
export const toolName = `getlinkstopdomains`;
export const toolDescription = `Top domains`;
export const baseUrl = `https://api.botify.com/v1`;
export const path = `/analyses/{username}/{project_slug}/{analysis_slug}/features/top_domains/domains`;
