import { z } from "zod";
export const toolName = `gettreasuryinboundtransfers`;
export const toolDescription = `List all InboundTransfers`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/treasury/inbound_transfers`;
