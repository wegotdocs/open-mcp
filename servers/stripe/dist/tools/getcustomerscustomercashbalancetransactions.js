import { z } from "zod";
export const toolName = `getcustomerscustomercashbalancetransactions`;
export const toolDescription = `List cash balance transactions`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/customers/{customer}/cash_balance_transactions`;
