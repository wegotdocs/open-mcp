import { z } from "zod";
export const toolName = `getinvoicerenderingtemplates`;
export const toolDescription = `List all invoice rendering templates`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/invoice_rendering_templates`;
