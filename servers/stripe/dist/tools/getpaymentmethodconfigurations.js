import { z } from "zod";
export const toolName = `getpaymentmethodconfigurations`;
export const toolDescription = `List payment method configurations`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/payment_method_configurations`;
