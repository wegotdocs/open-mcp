import { z } from "zod";
export const toolName = `getquotesquotelineitems`;
export const toolDescription = `Retrieve a quote's line items`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/quotes/{quote}/line_items`;
