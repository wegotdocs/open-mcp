import { z } from "zod";
export const toolName = `getexchangerates`;
export const toolDescription = `List all exchange rates`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/exchange_rates`;
