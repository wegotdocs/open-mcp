import { z } from "zod";
export const toolName = `gettaxregistrations`;
export const toolDescription = `List registrations`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/tax/registrations`;
