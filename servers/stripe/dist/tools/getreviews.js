import { z } from "zod";
export const toolName = `getreviews`;
export const toolDescription = `List all open reviews`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/reviews`;
