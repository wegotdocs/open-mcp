import { z } from "zod";
export const toolName = `getsourcessourcesourcetransactions`;
export const toolDescription = `<p>List source transactions for a given source.</p>`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/sources/{source}/source_transactions`;
