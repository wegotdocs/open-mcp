import { z } from "zod";
export const toolName = `getpaymentmethoddomains`;
export const toolDescription = `List payment method domains`;
export const baseUrl = `https://api.stripe.com`;
export const path = `/v1/payment_method_domains`;
