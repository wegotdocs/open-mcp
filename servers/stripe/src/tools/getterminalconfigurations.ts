...
export const toolName = `getterminalconfigurations`
export const toolDescription = `List all Configurations`
export const baseUrl = `https://api.stripe.com`
export const path = `/v1/terminal/configurations`
