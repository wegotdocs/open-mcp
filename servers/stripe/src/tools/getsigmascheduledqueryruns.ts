...
export const toolName = `getsigmascheduledqueryruns`
export const toolDescription = `List all scheduled query runs`
export const baseUrl = `https://api.stripe.com`
export const path = `/v1/sigma/scheduled_query_runs`
