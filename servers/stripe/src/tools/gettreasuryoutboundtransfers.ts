...
export const toolName = `gettreasuryoutboundtransfers`
export const toolDescription = `List all OutboundTransfers`
export const baseUrl = `https://api.stripe.com`
export const path = `/v1/treasury/outbound_transfers`
