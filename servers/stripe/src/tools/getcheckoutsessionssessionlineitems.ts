...
export const toolName = `getcheckoutsessionssessionlineitems`
export const toolDescription = `Retrieve a Checkout Session's line items`
export const baseUrl = `https://api.stripe.com`
export const path = `/v1/checkout/sessions/{session}/line_items`
