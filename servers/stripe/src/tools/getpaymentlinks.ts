...
export const toolName = `getpaymentlinks`
export const toolDescription = `List all payment links`
export const baseUrl = `https://api.stripe.com`
export const path = `/v1/payment_links`
