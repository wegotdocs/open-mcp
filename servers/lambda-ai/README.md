...
```bash
npx @open-mcp/lambda-ai add-to-client ~/Library/Application\ Support/Claude/claude_desktop_config.json
```
...
```bash
npx @open-mcp/lambda-ai add-to-client .cursor/mcp.json
```

### Other

```bash
npx @open-mcp/lambda-ai add-to-client /path/to/client/config.json
```
