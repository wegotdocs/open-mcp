import { z } from "zod";
export const toolName = `employeeschedulesall`;
export const toolDescription = `List Employee Schedules`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/hris/schedules/employees/{employee_id}`;
