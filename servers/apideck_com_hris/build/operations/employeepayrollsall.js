import { z } from "zod";
export const toolName = `employeepayrollsall`;
export const toolDescription = `List Employee Payrolls`;
export const baseUrl = `https://unify.apideck.com`;
export const path = `/hris/payrolls/employees/{employee_id}`;
