...
export const toolName = `payrollsone`
export const toolDescription = `Get Payroll`
export const baseUrl = `https://unify.apideck.com`
export const path = `/hris/payrolls/{payroll_id}`
