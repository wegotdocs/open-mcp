...
export const toolName = `postaccountsaccountexternalaccountsid`
...
export const inputParams = z.object({ "path": z.object({ "account": z.string().max(5000), "id": z.string() }).optional() }).shape