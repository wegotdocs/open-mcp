...
export const inputParams = z.object({ "path": z.object({ "account": z.string().max(5000), "id": z.string().describe("Unique identifier for the external account to be deleted.") }).optional() }).shape