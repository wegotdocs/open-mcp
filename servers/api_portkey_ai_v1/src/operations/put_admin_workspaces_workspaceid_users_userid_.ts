...
export const inputParams = z.object({ "path": z.object({ "workspaceId": z.string(), "userId": z.string() }).optional(), "body": z.object({ "role": z.enum(["admin","member"]).optional() }).optional() }).shape