...
export const toolName = `listfilesinvectorstorebatch`
export const toolDescription = `Returns a list of vector store files in a batch.`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/vector_stores/{vector_store_id}/file_batches/{batch_id}/files`
