...
export const toolName = `getrunstep`
export const toolDescription = `Retrieves a run step.`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/threads/{thread_id}/runs/{run_id}/steps/{step_id}`
...
export const inputParams = z.object({ "path": z.object({ "thread_id": z.string().describe("The ID of the thread to which the run and run step belongs."), "run_id": z.string().describe("The ID of the run to which the run step belongs."), "step_id": z.string().describe("The ID of the run step to retrieve.") }).optional() }).shape