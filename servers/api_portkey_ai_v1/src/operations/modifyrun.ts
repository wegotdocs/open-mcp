...
export const toolName = `modifyrun`
export const toolDescription = `Modifies a run.`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/threads/{thread_id}/runs/{run_id}`
...
export const inputParams = z.object({ "path": z.object({ "thread_id": z.string().describe("The ID of the [thread](https://platform.openai.com/docs/api-reference/threads) that was run."), "run_id": z.string().describe("The ID of the run to modify.") }).optional(), "body": z.object({ "metadata": z.record(z.any()).nullable().describe("Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maxium of 512 characters long.\n").optional() }).strict().optional() }).shape