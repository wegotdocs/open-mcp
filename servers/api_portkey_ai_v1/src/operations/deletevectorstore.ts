...
export const toolName = `deletevectorstore`
export const toolDescription = `Delete a vector store.`
...
export const inputParams = z.object({ "path": z.object({ "vector_store_id": z.string().describe("The ID of the vector store to delete.") }).optional() }).shape