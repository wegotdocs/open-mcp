...
export const toolName = `cancelvectorstorefilebatch`
export const toolDescription = `Cancel a vector store file batch. This attempts to cancel the processing of files in this batch as soon as possible.`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/vector_stores/{vector_store_id}/file_batches/{batch_id}/cancel`
...
export const inputParams = z.object({ "path": z.object({ "vector_store_id": z.string().describe("The ID of the vector store that the file batch belongs to."), "batch_id": z.string().describe("The ID of the file batch to cancel.") }).optional() }).shape