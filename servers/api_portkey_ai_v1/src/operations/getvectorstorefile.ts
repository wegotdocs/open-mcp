...
export const toolName = `getvectorstorefile`
export const toolDescription = `Retrieves a vector store file.`
...
export const inputParams = z.object({ "path": z.object({ "vector_store_id": z.string().describe("The ID of the vector store that the file belongs to."), "file_id": z.string().describe("The ID of the file being retrieved.") }).optional() }).shape