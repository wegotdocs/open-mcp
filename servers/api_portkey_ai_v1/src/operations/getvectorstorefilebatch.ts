...
export const toolName = `getvectorstorefilebatch`
export const toolDescription = `Retrieves a vector store file batch.`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/vector_stores/{vector_store_id}/file_batches/{batch_id}`
...
export const inputParams = z.object({ "path": z.object({ "vector_store_id": z.string().describe("The ID of the vector store that the file batch belongs to."), "batch_id": z.string().describe("The ID of the file batch being retrieved.") }).optional() }).shape