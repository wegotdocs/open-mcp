import { z } from "zod";
export const toolName = `get_restaurants_tenant_restaurantid_catalogue_items_itemid_varia`;
export const toolDescription = `Get all menu item variations`;
export const baseUrl = `https://uk.api.just-eat.io`;
export const path = `/restaurants/{tenant}/{restaurantId}/catalogue/items/{itemId}/variations`;
