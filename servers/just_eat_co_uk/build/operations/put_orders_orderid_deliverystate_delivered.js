import { z } from "zod";
export const toolName = `put_orders_orderid_deliverystate_delivered`;
export const toolDescription = `Update order with delivered details`;
export const baseUrl = `https://uk.api.just-eat.io`;
export const path = `/orders/{orderId}/deliverystate/delivered`;
