...
export const toolName = `put_driver_at_delivery_address`
export const toolDescription = `Driver at delivery address`
export const baseUrl = `https://uk.api.just-eat.io`
export const path = `/driver-at-delivery-address`
