...
```bash
npx @open-mcp/config add Openai-chicuza \
...
```json
{
  "mcpServers": {
    "Openai-chicuza": {
      "command": "npx",
      "args": ["-y", "@open-mcp/Openai-chicuza"],
      "env": {"API_KEY":"..."}
    }
  }
}
...
```bash
npx -y @modelcontextprotocol/inspector npx -y @open-mcp/Openai-chicuza
```

- Open http://localhost:5173
- Transport type: `STDIO`
- Command: `npx`
- Arguments: `-y @open-mcp/Openai-chicuza`
