...
export const inputParamsSchema = {
  ...
  "transactionAssetDecimals": z.number().describe("Number of decimals in the transaction asset. This is used to convert the transaction amount to the smallest unit of the asset").optional(),
  ...
  "beneficiaryAddress": z.record(z.any()).describe("<llm-instruction>This part of the input schema is truncated. If you want to pass the property `beneficiaryAddress` to the tool, first call the tool `expandSchema` with \"/properties/beneficiaryAddress\" in the list of pointers. This will return the expanded input schema which you can then use in the tool call. You may have to call `expandSchema` multiple times if the schema is nested.</llm-instruction>").optional(),
