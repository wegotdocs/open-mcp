...
export const inputParamsSchema = {
  "ncwId": z.string().describe("Tenant's Non-Custodial Wallet ID").optional(),
  "walletType": z.enum(["VAULT_ACCOUNT","END_USER_WALLET"]).describe("Wallet type, it can be `VAULT_ACCOUNT` or `END_USER_WALLET`").optional(),
  "search": z.string().describe("Search owned collections. Possible criteria for search: collection name, collection contract address.").optional(),
