...
export const inputParamsSchema = {
  ...
  "type": z.enum(["ASYNC","DVP"]).describe("Type of transfer. ASYNC executes transfers as they are funded, ATOMIC executes all terms (legs) as one atomic transfer").optional(),
