...
export const inputParamsSchema = {
  "before": z.string().describe("Unix timestamp in milliseconds. Returns only transactions created before the specified date").optional(),
  "after": z.string().describe("Unix timestamp in milliseconds. Returns only transactions created after the specified date").optional(),
  "status": z.string().describe("You can filter by one of the statuses.").optional(),
  ...
  "destType": z.enum(["VAULT_ACCOUNT","EXCHANGE_ACCOUNT","INTERNAL_WALLET","EXTERNAL_WALLET","CONTRACT","FIAT_ACCOUNT","NETWORK_CONNECTION","COMPOUND","ONE_TIME_ADDRESS","END_USER_WALLET"]).describe("The destination type of the transaction").optional(),
