...
export const inputParamsSchema = {
  ...
  "id": z.string().describe("id of position to unstake"),
  ...
  "amount": z.string().describe("The number of tokens to unstake.  This optional field is applicable only for liquid staking and allows for a partial unstake of the position.  If not provided, the entire position will be unstaked by default.").optional(),
