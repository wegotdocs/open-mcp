...
export const inputParams = {
  "card_back_img": z.string().describe("受益人证件反面照（使用图片上传接口的image_id）。当证件类型为身份证时，此字段必传；当证件类型为非身份证时，此字段非必传。").optional(),
  "card_front_img": z.string().describe("受益人证件正面照（使用图片上传接口的image_id）").optional(),
  ...
  "person_name": z.string().describe("受益人姓名").optional()
}