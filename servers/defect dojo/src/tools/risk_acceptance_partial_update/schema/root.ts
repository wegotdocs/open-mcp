...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this risk_ acceptance."),
  "name": z.string().min(1).max(300).describe("Descriptive name which in the future may also be used to group risk acceptances together across engagements and products").optional(),
  ...
  "owner": z.number().int().describe("User in DefectDojo owning this acceptance. Only the owner and staff users can edit the risk acceptance.").optional(),
