...
export const inputParamsSchema = {
  ...
  "name": z.string().min(1).max(128).describe("The name of the regulation.").optional(),
  "acronym": z.string().min(1).max(20).describe("A shortened representation of the name.").optional(),
  ...
  "jurisdiction": z.string().min(1).max(64).describe("The territory over which the regulation applies.").optional(),
