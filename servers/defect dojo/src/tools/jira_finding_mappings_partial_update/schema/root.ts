...
export const inputParamsSchema = {
  "id": z.number().int().describe("A unique integer value identifying this jir a_ issue."),
  "jira_id": z.string().min(1).max(200).optional(),
  "jira_key": z.string().min(1).max(200).optional(),
