...
export const inputParamsSchema = {
  ...
  "title": z.string().min(1).max(511).describe("A short description of the flaw."),
  ...
  "severity": z.string().min(1).max(200).describe("The severity level of this flaw (Critical, High, Medium, Low, Info)."),
  "description": z.string().min(1).describe("Longer more descriptive information about the flaw."),
  ...
  "active": z.boolean().describe("Denotes if this flaw is active or not."),
  "verified": z.boolean().describe("Denotes if this flaw has been manually verified by the tester."),
  ...
  "numerical_severity": z.string().min(1).max(4).describe("The numerical representation of the severity (S0, S1, S2, S3, S4)."),
