import { z } from "zod";
export const toolName = `get_marketdata_snapshot`;
export const toolDescription = `Market Data Snapshot`;
export const baseUrl = `https://www.interactivebrokers.com/tradingapi/v1`;
export const path = `/marketdata/snapshot`;
