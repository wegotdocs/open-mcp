...
export const toolName = `customobjectrecordbulkjobs`
export const toolDescription = `Custom Object Record Bulk Jobs`
export const baseUrl = `https://{subdomain}.{domain}.com`
export const path = `/api/v2/custom_objects/{custom_object_key}/jobs`
