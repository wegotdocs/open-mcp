...
export const toolName = `createbrand`
export const toolDescription = `Create Brand`
export const baseUrl = `https://{subdomain}.{domain}.com`
export const path = `/api/v2/brands`
