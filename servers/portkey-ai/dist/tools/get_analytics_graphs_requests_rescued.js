import { z } from "zod";
export const toolName = `get_analytics_graphs_requests_rescued`;
export const toolDescription = `Get retry and fallback rescued requests graph`;
export const baseUrl = `https://api.portkey.ai/v1`;
export const path = `/analytics/graphs/requests/rescued`;
