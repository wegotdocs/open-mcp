import { z } from "zod";
export const toolName = `get_analytics_groups_metadata_metadatakey_`;
export const toolDescription = `Get metadata key based grouped data.`;
export const baseUrl = `https://api.portkey.ai/v1`;
export const path = `/analytics/groups/metadata/{metadataKey}`;
