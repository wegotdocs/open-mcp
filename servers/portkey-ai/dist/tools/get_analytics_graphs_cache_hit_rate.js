import { z } from "zod";
export const toolName = `get_analytics_graphs_cache_hit_rate`;
export const toolDescription = `Get cache hit rate graph`;
export const baseUrl = `https://api.portkey.ai/v1`;
export const path = `/analytics/graphs/cache/hit-rate`;
