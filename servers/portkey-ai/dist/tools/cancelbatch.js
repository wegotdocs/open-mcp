...
export const toolDescription = `Cancels an in-progress batch. The batch will be in status `, cancelling;
` for up to 10 minutes, before changing to `;
...
export const inputParams = z.object({ "batch_id": z.string().describe("The ID of the batch to cancel.") }).shape;
