...
const tool: OpenMCPServerTool = {
  "toolName": "createfile",
  "toolDescription": "Upload a file to be used across various endpoints, such as Assistant (<2M tokens), Fine-Tuning, and Batch (<100 MB). Total size of your bucket is 100 GB.",
