...
export const toolName = `get_analytics_graphs_feedbacks_scores`
export const toolDescription = `Get score-wise feedbacks distribution graph`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/analytics/graphs/feedbacks/scores`
