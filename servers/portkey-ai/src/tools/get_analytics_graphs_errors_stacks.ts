...
export const toolName = `get_analytics_graphs_errors_stacks`
export const toolDescription = `Get status code wise stacked error graph`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/analytics/graphs/errors/stacks`
