...
export const toolName = `get_analytics_graphs_feedbacks_ai_models`
export const toolDescription = `Get feedbacks per ai_models graph`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/analytics/graphs/feedbacks/ai-models`
