...
export const toolName = `get_analytics_graphs_feedbacks_weighted`
export const toolDescription = `Get weighted feedbacks graph. Weighted feedback is (value * score)`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/analytics/graphs/feedbacks/weighted`
