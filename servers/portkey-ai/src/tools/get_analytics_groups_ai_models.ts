...
export const toolName = `get_analytics_groups_ai_models`
export const toolDescription = `Get ai model grouped data.`
export const baseUrl = `https://api.portkey.ai/v1`
export const path = `/analytics/groups/ai-models`
