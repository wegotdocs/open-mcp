...
export const toolName = `kpisfordailyappuninstallsbydate`
export const toolDescription = `KPIs for Daily App Uninstalls by Date`
export const baseUrl = `https://rest.iad-01.braze.com`
export const path = `/kpi/uninstalls/data_series`
