...
export const toolName = `monthlyactiveusersforlast30days`
export const toolDescription = `Monthly Active Users for Last 30 Days`
export const baseUrl = `https://rest.iad-01.braze.com`
export const path = `/kpi/mau/data_series`
