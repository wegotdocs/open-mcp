...
export const toolName = `enterprise_admin_remove_self_hosted_runner_from_group_for_enterp`
export const toolDescription = `Remove a self-hosted runner from a group for an enterprise`
