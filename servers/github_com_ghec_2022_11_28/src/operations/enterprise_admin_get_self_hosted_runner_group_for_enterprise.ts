...
export const toolName = `enterprise_admin_get_self_hosted_runner_group_for_enterprise`
export const toolDescription = `Get a self-hosted runner group for an enterprise`
