import { z } from "zod";
export const toolName = `enterprise_admin_list_self_hosted_runners_for_enterprise`;
export const toolDescription = `List self-hosted runners for an enterprise`;
export const baseUrl = `https://github.com`;
export const path = `/enterprises/{enterprise}/actions/runners`;
