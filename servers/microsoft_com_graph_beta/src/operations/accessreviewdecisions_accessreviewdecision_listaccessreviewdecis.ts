...
export const toolName = `accessreviewdecisions_accessreviewdecision_listaccessreviewdecis`
export const toolDescription = `Get entities from accessReviewDecisions`
