import { z } from "zod";
export const toolName = `apps_list_accounts_for_plan_stubbed`;
export const toolDescription = `List accounts for a plan (stubbed)`;
export const baseUrl = `https://api.github.com`;
export const path = `/marketplace_listing/stubbed/plans/{plan_id}/accounts`;
