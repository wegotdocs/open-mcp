...
export const toolName = `post_hub_spaces_spaceid_payslips`
export const toolDescription = `Add a payslip in a space (this document is analyzed to be saved in the correct folder)`
export const baseUrl = `https://sandbox.gerermesaffaires.com/api/v1`
export const path = `/hub/spaces/{spaceId}/payslips`
