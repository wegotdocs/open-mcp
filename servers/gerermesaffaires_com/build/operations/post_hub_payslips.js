import { z } from "zod";
export const toolName = `post_hub_payslips`;
export const toolDescription = `Add a payslip (this document is analyzed to be saved in the correct folder and correct space)`;
export const baseUrl = `https://sandbox.gerermesaffaires.com/api/v1`;
export const path = `/hub/payslips`;
