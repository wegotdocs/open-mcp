...
export const toolName = `gettweetsfirehosestream`
export const toolDescription = `Firehose stream`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/tweets/firehose/stream`
