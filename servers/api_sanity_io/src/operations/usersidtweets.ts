...
export const toolName = `usersidtweets`
export const toolDescription = `User Tweets timeline by User ID`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/users/{id}/tweets`
