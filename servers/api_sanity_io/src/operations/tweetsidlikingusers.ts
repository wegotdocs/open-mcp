...
export const toolName = `tweetsidlikingusers`
export const toolDescription = `Returns User objects that have liked the provided Tweet ID`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/tweets/{id}/liking_users`
