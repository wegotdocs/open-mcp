...
export const toolName = `usersidlike`
export const toolDescription = `Causes the User (in the path) to like the specified Tweet`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/users/{id}/likes`
