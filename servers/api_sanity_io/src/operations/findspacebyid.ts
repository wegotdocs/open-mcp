...
export const toolName = `findspacebyid`
export const toolDescription = `Space lookup by Space ID`
export const baseUrl = `https://api.twitter.com`
export const path = `/2/spaces/{id}`
