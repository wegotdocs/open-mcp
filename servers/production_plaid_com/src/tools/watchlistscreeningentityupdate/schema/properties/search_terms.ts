...
export const inputParamsSchema = {
  ...
  "legal_name": z.string().describe("The name of the organization being screened. Must have at least one alphabetical character, have a maximum length of 100 characters, and not include leading or trailing spaces.").optional(),
  ...
  "phone_number": z.string().describe("A phone number in E.164 format.").optional(),
  "url": z.string().url().describe("An 'http' or 'https' URL (must begin with either of those).").optional()
}