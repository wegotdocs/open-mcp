...
export const inputParamsSchema = {
  "watchlist_program_id": z.string().describe("ID of the associated program.").optional(),
  "legal_name": z.string().describe("The legal name of the individual being screened. Must have at least one alphabetical character, have a maximum length of 100 characters, and not include leading or trailing spaces.").optional(),
